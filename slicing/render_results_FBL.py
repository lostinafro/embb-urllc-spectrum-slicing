...
def power_outage(urllc_freqs: list, urllc_minis: int, urllc_rate: float, embb_rate: float, embb_snr: list, name='', render=False, verbose=True):
    # Read results
    # noma_results, _ = read_data(urllc_freqs, urllc_minis, urllc_rate, embb_rate, name)
...
if __name__ == '__main__':
    ...
    if R:
        output_dir = os.path.join(os.path.expanduser('~'), 'uni/plots/slicing', str(date.today()))
